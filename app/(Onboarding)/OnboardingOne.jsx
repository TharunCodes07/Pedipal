  ...
  return (
    <View className="bg-primary w-full h-full justify-center">
      ...
      <View className="w-100">
        ...
        Instant Expert Advice for Your Child’s Health
        </Text>
        <Text className="text-gray-300 font-pmedium text-lg text-center leading-6">
          
Get quick and reliable answers to your parenting and health-related questions with our pediatrician chatbot, 
