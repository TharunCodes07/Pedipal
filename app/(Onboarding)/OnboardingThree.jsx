    ...
    return (
        <View className="w-100 bg-primary w-full h-full justify-center">
            ...
            <View className="w-100">
                ...
                Easily manage your child's health and get trusted advice with our intuitive pediatric care assistant.
                </Text>
            </View>
            ...
            <View className="mt-14 mx-3">
                <TouchableOpacity
                    ...
                    className="bg-[#FF69B4] flex-row items-center justify-center p-3 rounded-full ">
                    <Image
